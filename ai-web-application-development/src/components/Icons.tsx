...
export const Icon = {
  ...
  Spinner: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p} strokeWidth={2.5}><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>
  ),
  ...
  Trash: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><polyline points="3 6 5 6 21 6"/><path d="M19 6l-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6"/></svg>
  ),
  ...
  Sparkles: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><path d="M12 3l1.9 5.7L20 10l-5.5 2L13 18l-2.5-5.5L5 11l5.6-1.8L12 3z"/><path d="M19 15l.8 2.4L22 18l-2.2.6L19 21l-.8-2.4L16 18l2.2-.6L19 15z"/></svg>
  ),
...
export function Logo({ size = 36 }: { size?: number }) {
  return (
    <div
      className="rounded-xl bg-gradient-to-br from-violet-500 via-indigo-500 to-fuchsia-500 grid place-items-center shadow-lg shadow-indigo-500/30"
